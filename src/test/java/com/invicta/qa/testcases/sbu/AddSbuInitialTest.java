...
//013-ADD-SBU-BUTTON-BOX-SHADOW,014-ADD-SBU-BUTTON-PADDING,
	public static void addSbuButtonproperties() throws InterruptedException {
		...
		htmlreporter.config().setReportName("Test Report-Add SBU");
		htmlreporter.config().setDocumentTitle("QDMS reports");
		
		testCase=extent.createTest("STEP-1 \"ADD SBU BUTTON\" PROPERTIES");
...
//								button enabled
	...
	public static void addSubButtonClick() throws InterruptedException {
		...
		testCase = extent.createTest("STEP-2 CLICK ON \"ADD SBU\" BUTTON");
		
		Thread.sleep(2000);
		//WebElement element = driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/div[1]/div/img"));
		boolean AcctualVisible = AddSbuUIPage.SBUbutton.isDisplayed();
		...
		testCase = extent.createTest("015-ADD-SBU-BUTTON-IS-CLICKED");
		try {
...
//023-ADD-SBU-MODAL-Z-INDEX-TYPE,024-ADD-SBU-MODAL-HEADER,025-ADD-SBU-MODAL-CONTENT,026-MODAL-INVISIBLE-ONCLICK-INSIDE
	...
	public static void addSbuModalproperties() throws InterruptedException {
		...
		testCase = extent.createTest("STEP-3 CHECK THE \"ADD SBU\" DIALOGBOX");
		...
		testCase = extent.createTest("016-ADD SBU-DIALOGBOX-VISIBLE");
		try {
		...
		boolean Position = true;
		testCase = extent.createTest("017-ADD SBU- DIALOGBOX-POSITION");
		try {
			AssertJUnit.assertEquals(ActualLocation, ExpectedLocation);
		...
		boolean size = true;
		testCase = extent.createTest("018-ADD SBU-DIALOGBOX-SIZE");
		try {
			AssertJUnit.assertEquals(ActualSize, ExpectedSize);
		...
		testCase = extent.createTest("019-ADD SBU-DIALOGBOX-BACKGROUND-COLOR");
		try {
		...
		testCase = extent.createTest("020-ADD SBU-DIALOGBOX-BORDER-COLOR");
		try {
		...
		testCase = extent.createTest("021-ADD SBU-DIALOGBOX-OVERFLOW-TYPE");
		try {
		...
		boolean margin = true;
		testCase = extent.createTest("022-ADD SBU-DIALOGBOX-MARGIN-TYPE");
		try {
		...
		boolean cursor = true;
		testCase = extent.createTest("023-ADD SBU-DIALOGBOX-CURSOR-TYPE");
		try {
			AssertJUnit.assertEquals(ActualActions, ExpectedActions);
		...
		testCase = extent.createTest("024-ADD SBU-DIALOGBOX-Z-INDEX-TYPE");
		try {
		...
		testCase = extent.createTest("025-ADD SBU-DIALOGBOX-HEADER");
		try {
		...
		testCase = extent.createTest("026-ADD SBU-DIALOGBOX-CONTENT");
		try {
		...
		testCase = extent.createTest("027-ADD SBU-DIALOGBOX -INVISIBLE-ONCLICK-INSIDE");
		try {
...
//039-SAVE-BUTTON-BOX-SHADOW,040-SAVE-BUTTON-PADDING,
	public static void saveButtonProperties() throws InterruptedException {
		...
		testCase = extent.createTest("STEP-5 CHECK \"SAVE BUTTON\" PROPERTIES");
...
//						button Displayed
				...
				boolean ExpectedbuttonDisplay = true;
				testCase = extent.createTest("028-SAVE BUTTON-DISPLAYED");
				try {
					Assert.assertEquals(ActualbiuttonDisplay, ExpectedbuttonDisplay);
					testCase.log(Status.INFO, "Actual Image Displayed :- " + ActualbiuttonDisplay);
					testCase.log(Status.INFO, "Expected Image Displayed :- " + ExpectedbuttonDisplay);
...
//								button enabled
						...
						boolean ExpectedImageDisplay = true;
						testCase = extent.createTest("029-SAVE BUTTON-ENABLED");
						try {
							Assert.assertEquals(ActualImageDisplay, ExpectedImageDisplay);
							testCase.log(Status.INFO, "Actual Image Displayed :- " + ActualImageDisplay);
							testCase.log(Status.INFO, "Expected Image Displayed :- " + ExpectedImageDisplay);
						...
						boolean position = true;
						testCase = extent.createTest("030-SAVE BUTTON-POSITION");
						try {
							AssertJUnit.assertEquals(ActualLocation, ExpectedLocation);
						} catch (AssertionError e) {
							position = false;
						...
						boolean fontsize = true;
						testCase = extent.createTest("031-SAVE BUTTON-FONT-SIZE");
						try {
							AssertJUnit.assertEquals(ActualfontsSize, ExpectedfontsSize);
						} catch (AssertionError e) {
							fontsize = false;
						...
						boolean size = true;
						testCase = extent.createTest("032-SAVE BUTTON-SIZE");
						try {
							AssertJUnit.assertEquals(ActualSize, ExpectedSize);
						} catch (AssertionError e) {
							size = false;
						...
						testCase = extent.createTest("033-SAVE BUTTON-COLOUR");
						try {
							AssertJUnit.assertEquals(ActualColour, ExpectedColour);
						} catch (AssertionError e) {
							colour = false;
						...
						testCase = extent.createTest("034-SAVE BUTTON-BORDER-COLOUR");
						try {
							AssertJUnit.assertEquals(ActualBorderColour, ExpectedBorderColour);
						} catch (AssertionError e) {
							BorderColour = false;
						...
						boolean fontcolour = true;
						testCase = extent.createTest("035-SAVE BUTTON-FONT-COLOUR");
						try {
							AssertJUnit.assertEquals(ActualfontsColour, ExpectedfontsColour);
						} catch (AssertionError e) {
							fontcolour = false;
						...
						boolean fonttype = true;
						testCase = extent.createTest("036-SAVE BUTTON-FONT-TYPE");
						try {
							AssertJUnit.assertEquals(ActualfontsType, ExpectedfontsType);
						} catch (AssertionError e) {
							fonttype = false;
						...
						boolean test = true;
						testCase = extent.createTest("037-SAVE BUTTON-TEXT");
						try {
							AssertJUnit.assertEquals(ActualText, ExpectedText);
						} catch (AssertionError e) {
							test = false;
						...
						boolean cursor = true;
						testCase = extent.createTest("038-SAVE BUTTON-CURSOR-TYPE");
						try {
							AssertJUnit.assertEquals(ActualActions, ExpectedActions);
						...
						boolean shape = true;
						testCase = extent.createTest("039-SAVE BUTTON-SHAPE");
						try {
							AssertJUnit.assertEquals(ActualShape, ExpectedShape);
						...
						boolean shadow = true;
						testCase = extent.createTest("040-SAVE BUTTON-BOX-SHADOW");
						try {
							AssertJUnit.assertEquals(ActualShadow, ExpectedShadow);
						...
						boolean padding = true;
						testCase = extent.createTest("041-SAVE BUTTON-PADDING");
						try {
							AssertJUnit.assertEquals(ActualPadding, ExpectedPadding);
	...
	// STEP-6 CLICK ON "SAVE BUTTON"
		...
		public static void saveButtonClick() throws InterruptedException {
			...
			testCase = extent.createTest("STEP-6 STEP-6 CLICK ON \"SAVE BUTTON\"");
			...
			testCase = extent.createTest("042-ADD-SBU-BUTTON-IS-CLICKED");
			try {
				AssertJUnit.assertEquals(String.valueOf(AcctualVisible), "true");
				//System.out.println(String.valueOf(clickable));
...
//041-LAST-ADDED-DATA
	public static void checkLastAddvalue() throws InterruptedException, IOException {
		...
		testCase = extent.createTest("043-ENTERED VALUE HAS SAVED AS FIRST OF THE TABLE");
		try {
